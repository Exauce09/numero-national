...
public class USBManager {
	...
	public static final String DEVICE_MODEL_CBM_E3 = "CBM-E3";
	...
	public static final String SOFTWAREID_CBM_E3 	= "CBM-E3";
	...
	static {
		...
		// MorphoTablet2 / MPH-MB001A — capteur optique interne CBM-E3
		supportedDevices.put(new USBDeviceAttributes(0x225D, 0x0008),DEVICE_MODEL_CBM_E3);
	}
				...
				if(USBManager.isSupported(l_attr))
				{
					...
					if (!hasPermission) {
						...
						usbManager.requestPermission(
								usbDevice,
								PendingIntent.getBroadcast(context, 0, new Intent(ACTION_USB_PERMISSION), piFlags)
						);
					}					
				}
			}
							...
							if(ret == USBConstants.RETURN_SUCCESS)
							{
								...
								{	
									...
									case 0x0007 :
										...
										break;
									// MorphoTablet2 CBM-E3
									case 0x0008 :
										attrs.setFreindlyName(SOFTWAREID_CBM_E3);
										break;
									default:
										break;
								}
	 ...
	 * 
	 * JNI (libMSO100): instance method listDevices()V — must not be static.
	 *
	 * @throws IOException
	 *             if enumeration fails for any reason
	 */
	public synchronized void listDevices() throws IOException {
		if (deviceList != null) {
	...
	/** JNI (libMSO100): instance method getNbDevices()I — must not be static. */
	public synchronized int getNbDevices() throws IOException {
		if (deviceList == null) return 0;
		return deviceList.size();
	}

	/** Convenience for Java callers. */
	public static synchronized USBDevice getFirstDevice() {
	...
	/** JNI (libMSO100): getDevice(I)Lcom/morpho/android/usb/USBDevice; */
	public synchronized USBDevice getDevice(int index) {
