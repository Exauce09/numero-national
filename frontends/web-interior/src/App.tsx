...
import { clearSession, getSession, updateInteriorPassword } from "./auth";
import {
  applyInteriorTheme,
  getInteriorPrefs,
  interiorUnreadCount,
  listInteriorNotifications,
  markAllInteriorNotificationsRead,
  markInteriorNotificationRead,
  saveInteriorPrefs,
  type InteriorNotification,
  type InteriorPrefs,
} from "./interiorPrefs";
import DashboardPage from "./pages/DashboardPage";
import { DisplacementsPage, MissingDocsPage, MovementsPage } from "./pages/InteriorLists";
...
function Shell() {
  ...
  const [prefs, setPrefs] = useState<InteriorPrefs>(() => getInteriorPrefs());
  const [notifs, setNotifs] = useState<InteriorNotification[]>(() => listInteriorNotifications());
  ...
  useEffect(() => {
    applyInteriorTheme(prefs.theme);
  }, [prefs.theme]);
  ...
  function persistPrefs(next: InteriorPrefs) {
    saveInteriorPrefs(next);
    setPrefs(next);
  }
  ...
  function onChangePassword(e: FormEvent) {
    ...
    try {
      updateInteriorPassword(currentPwd, newPwd);
      setCurrentPwd("");
      setNewPwd("");
      setConfirmPwd("");
  ...
  const badge = interiorUnreadCount();
    ...
    <div className={`page-wrapper${navOpen ? " nav-open" : ""}`}>
      ...
      <aside className="sidebar" id="app-sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink to="/mouvements" onClick={() => setNavOpen(false)}>
            Mouvements
          </NavLink>
          <NavLink to="/deplacements" onClick={() => setNavOpen(false)}>
            Déplacements
          </NavLink>
          <NavLink to="/documents-manquants" onClick={() => setNavOpen(false)}>
            Documents manquants
          </NavLink>
          <NavLink to="/parcours" onClick={() => setNavOpen(false)}>
            Parcours citoyen
          </NavLink>
        </nav>
      ...
      <div className="body-wrap">
        <header className="topbar topbar-3">
          <div className="topbar-left">
            ...
            <h1 className="topbar-title">Ministère de l&apos;Intérieur</h1>
          </div>
          <div className="topbar-center">
            <span className="topbar-role">Institution Intérieur</span>
            <strong className="topbar-responsable">Supervision mouvements &amp; parcours</strong>
          </div>
          <div className="topbar-right">
            <button
              ...
              onClick={() => {
                ...
                setNotifs(listInteriorNotifications());
              }}
            >
        ...
        <main className="shell">
          <Routes>
            ...
            <Route path="/deplacements" element={<DisplacementsPage />} />
            <Route path="/documents-manquants" element={<MissingDocsPage />} />
            ...
            <div className="panel-head">
              ...
              <div className="modal-actions" style={{ margin: 0 }}>
                <button
                  ...
                  onClick={() => setNotifs(markAllInteriorNotificationsRead())}
                >
                  Tout marquer lu
                </button>
                ...
                <div className="table-actions">
                  {!n.read ? (
                    <button
                      type="button"
                      className="btn-secondary btn-sm"
                      onClick={() => setNotifs(markInteriorNotificationRead(n.id))}
                    >
                      Marquer lu
                    </button>
                  ) : null}
                  {n.href ? (
                    <button
                      ...
                      onClick={() => {
                        setNotifs(markInteriorNotificationRead(n.id));
                        setNotifOpen(false);
                        navigate(n.href!);
                      }}
                    >
        ...
        <div className="modal-backdrop" onClick={() => setProfileOpen(false)}>
          <div className="modal-panel" onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ display: "flex", gap: "1rem", alignItems: "center", marginBottom: "1rem" }}>
              ...
              <div>
                <strong>Ministère de l&apos;Intérieur</strong>
